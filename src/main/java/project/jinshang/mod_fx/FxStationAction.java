...
@RestController
@RequestMapping(value = {"/rest/admin/fxstation"})
@Api(tags = "后台三级分销设置管理", description = "三级分销设置接口")
...
public class FxStationAction {
    ...
    @PreAuthorize("hasAuthority('" + AdminAuthorityConst.THIRDDISTRIBUTIONSETTINGS + "')")
