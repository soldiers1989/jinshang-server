...
import project.jinshang.mod_member.service.MemberAdminService;
...
public class MemberAdminRestAction {
        ...
        @ApiImplicitParams({
                ...
                @ApiImplicitParam(value = "业务员",name = "clerkname",required = true,paramType = "query"),
        ...
        public PageRet selectmemberinfo(MemberAdminQueryDto dto,
